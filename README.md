...
Small .NET sample: length and weight quantities with multi-unit arithmetic and conversions, now supporting extensible measurement categories via generics.
