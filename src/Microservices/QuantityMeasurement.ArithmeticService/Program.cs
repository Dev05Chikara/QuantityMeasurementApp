...
using QuantityMeasurement.ArithmeticService.Data;
...
builder.Services.AddDbContext<ArithmeticDbContext>(o =>
...
builder.Services.AddScoped<ArithmeticOperationService>();
